<%-- 
    Document   : BusquedaPorSender
    Created on : 8/06/2018, 12:28:20 PM
    Author     : Mauricio
--%>
...
<html>
    ...
    <body>
        ...
        <form action = "ShowTradingPartners">
            <label>Trading Partner: </label>  <input name = "Sender" type="text">
            <br>     
        ...
        <table class="table table-bordered">
                ...
                <tbody>
         <%
            if(session.getAttribute("lSenderReceivers")!=null)
            {   
                
                Consultas con = new Consultas();
                List<SenderReceiver> lSenderReceivers =(LinkedList<SenderReceiver>)session.getAttribute("lSenderReceivers");
